          ...
          <div class="card-body">
            <div class="container-fluid p-0">
              <div class="row align-items-center">
                <div class="col">
                  <h5 class="card-title">구인구직</h5>
                </div>
                <div class="col-auto">
                  <button type="button" class="btn btn-primary noticeBtn"> 글쓰기</button>
                </div>
              </div>
            </div>
            <div class="container-fluid p-0">
              <div class="row align-items-end">
                <div class="col mb-3">
                  <div class="explainBoard ">업체는 구인, 강사는 구직 활동을 할 수 있는 소통 공간 입니다</div>
                </div>
                <div class="col-auto">
            ...
            <table class="table text-center table-hover">
              ...
              <c:forEach items="${notList}" var="noticeColumn">
                <tr>
                  ...
                  <td>
                    <fmt:parseDate value="${noticeColumn.regDate}" pattern="yyyy-MM-dd'T'HH:mm" var="parsedDateTime" type="both" />
...
<script>
  ...
  qsAddEvent(".pagination", "click", (e)=>{
    ...
    jobBoardListForm.setAttribute("action", "/shop/job")
  ...
  qsAddEvent(".jobBoardTable", "click", (e)=>{
    ...
    jobBoardListForm.setAttribute("action", "/shop/job/read/" + url)
    jobBoardListForm.submit()
  })
  ...
  qsAddEvent(".noticeBoardTable", "click", (e)=>{
    ...
    jobBoardListForm.setAttribute("action", "/shop/job/noticeModify/" + url)
    jobBoardListForm.submit()
  })

  qsAddEvent(".noticeBtn", "click", (e) =>{
    self.location = `/shop/job/write`
  })
