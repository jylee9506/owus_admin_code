                                ...
                                <div class="accordion-body container-fluid itemsBody">
                                    <table class="table text-center shopInfo">
                                        ...
                                        <tr>
                                            <td>${d.fno}</td>
                                            <td>${d.name}</td>
                                            <td><input type=<c:set var="flag" value="false"/>
                                                                <c:forEach items="${dtoOfShop}" var="ds">
                                                                   <c:set var="fnoOfShop" value="${ds.fno}"/>
                                                                    <c:if test="${d.fno eq fnoOfShop}">
                                                            ...
                                                            value="${d.fno}" class="facility-checkbox"></td>
                                             </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
...
<script>
    ...
    qsAddEvent(".facilitySelectBtn", "click", (e) => {
        ...
        actionForm.setAttribute("action", "/shop/mypage/info/facilityAdd/add")
