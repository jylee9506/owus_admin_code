...
<script>
    ...
    qsAddEvent(".imageUploadBtn", "click", (e) => {
        ...
        uploadToServer(formObj).then(resultArr => {
            uploadResult.innerHTML += resultArr.map(result => `<div class ='addImage'>
    ...
    axios.get(`/details/gallery/\${mno}`).then(resultArr => {

        uploadResult.innerHTML += resultArr.data.map(result => `<div >
                <img data-uuid ='\${result.uuid}'
                    data-filename='\${result.filename}'
                    data-filepath ='\${result.filepath}'
                    data-img='\${result.img}'
    ...
    qsAddEvent(".cancelBtn", "click", (e) => {
        const linkes = uploadResult.querySelectorAll(".addImage button")
        for (let link of linkes) {
