package com.owus.shop.controller.job;
...
@Log4j2
@Controller
@RequestMapping("/shop/job")
@RequiredArgsConstructor
public class ShopJobBoardController {
    ...
    public String modify(ListDTO listDTO, JobBoardDTO jobBoardDTO, RedirectAttributes rttr){
        ...
        return "redirect:/shop/job/modify/" + jobBoardDTO.getBno() + listDTO.getLink();
    ...
    public String noticeModify(@PathVariable("bno") Integer bno, ListDTO listDTO, Model model){
        ...
        return "/shop/job/noticeModify";
    }


    @PostMapping("/write")
    public String write(JobBoardDTO jobBoardDTO, ListDTO listDTO , RedirectAttributes rttr, Model model){

        Integer bno = jobBoardService.insertShop(jobBoardDTO);

        log.info(jobBoardDTO.getUploads());

        rttr.addFlashAttribute("result", "success");

        return "redirect:/shop/job/modify/" + bno + listDTO.getLink();
    }
